...
<div id="core" class="columns">
    <div style="margin-bottom: 20px">
		<h2>Sermons</h2>
		<?php query_posts( 'post_type=peace_sermon&post_status=publish&posts_per_page=5&order=DESC'); ?>
	...
	<div style="margin-bottom: 20px">
    	...
    	<div>
    		<h2>Bulletins</h2>
    		<?php query_posts( 'post_type=peace_bulletin&post_status=publish&posts_per_page=5&order=DESC'); ?>
    		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    		<?php
    			$attachment_link = '#';
    			$args = array(
