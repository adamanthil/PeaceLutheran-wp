    ...
    <section id="main" role="main">
      <header>
        <div id="title">
          ...
          <h1><a href="<?php bloginfo('url'); ?>">Concordia Catechetical Academy</a></h1>
          <?php else: ?>
          <a href="<?php bloginfo('url'); ?>">Concordia Catechetical Academy</a>
          <?php endif; ?>
          <div class="loc">of Peace Lutheran Church—Sussex, Wisconsin</div>
        </div>
        <nav role="navigation">
